...
export function Link({
  className,
  ...props
}: TypographyProps<HTMLAnchorElement>) {
  return (
    <a
      className={cn(
...
export function ListItem({
  ...
  return (
    <li
      className={cn("text-foreground/90 text-[15px] leading-[1.75]", className)}
      {...props}
    />
  );
}
...
export function HorizontalRule({
  ...
  return (
    <hr className={cn("border-border my-8 md:my-12", className)} {...props} />
  );
}
...
export function Table({
  className,
  ...props
}: TypographyProps<HTMLTableElement>) {
  return (
...
export function TableHeader({
  className,
  ...props
}: TypographyProps<HTMLTableSectionElement>) {
  return (
    <thead
      className={cn("border-border bg-muted/50 border-b", className)}
      {...props}
    />
  );
}
...
export function TableRow({
  className,
  ...props
}: TypographyProps<HTMLTableRowElement>) {
  return (
    <tr
      className={cn(
