  ...
  ({ className, variant, size, children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        role="tablist"
        className={cn(
          tabsListVariants({ variant: finalVariant, size: finalSize }),
          className
        )}
        {...props}>
        {children}
  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          tabsTriggerVariants({ variant: finalVariant, size: finalSize }),
          className
        )}
        {...props}>
...
const TabsContent = React.forwardRef<HTMLDivElement, TabsContentProps>(
  (
    { className, value, animated, forceMount = false, children, ...props },
    ref
  ) => {
    const context = useTabsContext();
    const isActive = context.activeTab === value;
    ...
    return (
      <div
        ...
        hidden={!isActive}
        className={cn(
          tabsContentVariants({ animated: isActive ? animated : false }),
          className
        )}
        {...props}>
        {children}
